        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        bat "xcopy 'C:/Users/bennie.vdwalt/source/maven-project/webapp/target/*.war' '${params.tomcat_dev}' /s /y"
                    }
                }

                stage ("Deploy to Production"){
                    steps {
                        bat "xcopy 'C:/Users/bennie.vdwalt/source/maven-project/webapp/target/*.war' '${params.tomcat_prod}' /s /y"
                    }
                }
            }
        }
